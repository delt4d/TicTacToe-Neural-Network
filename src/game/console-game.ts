...
export class ConsoleGame implements Game {
    ...
    private displayBoard() {
        ...
        console.log(`*
*     |${squares[0].value?.symbol || squares[0].index}|${squares[1].value?.symbol || squares[1].index}|${squares[2].value?.symbol || squares[2].index}|
*     |${squares[3].value?.symbol || squares[3].index}|${squares[4].value?.symbol || squares[4].index}|${squares[5].value?.symbol || squares[5].index}|
*     |${squares[6].value?.symbol || squares[6].index}|${squares[7].value?.symbol || squares[7].index}|${squares[8].value?.symbol || squares[8].index}|`);
    }
